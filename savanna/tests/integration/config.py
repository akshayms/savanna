...
CLUSTER_NAME_CRUD = 'RV-cluster-crud'  # cluster name for crud operations
CLUSTER_NAME_HADOOP = 'RV-cluster-hadoop'  # cluster name for hadoop testing
...
SSH_KEY = 'vrovachev'
PLUGIN_NAME = 'vanilla'
PATH_TO_SSH = '/home/vadim/.ssh/id_rsa'

...
#-----------------------------------------------------------------------------------------------------------------------
    ...
    Scenario: User can get cluster by ID
        When User get cluster with id: "3"
        Then  Response is "200"
        And Response for list cluster by id is:"{u'status': u'Active', u'service_urls': {}, u'name': u'qacluster-1', u'base_image_id': u'd9342ba8-4c51-441c-8d5b-f9e14a901299', u'node_templates': {u'jt.medium': 1, u'tt_dn.small': 1, u'nn.medium': 1}, u'nodes': []}"
    ...
    Scenario: User can delete cluster by ID
        When User delete cluster with id: "5"
        Then  Response is "204"
    ...
    Scenario: User can delete cluster by ID
        When User delete cluster with id: "4"
        Then  Response is "204"
...
Scenario: User can get clusters if list is empty
    ...
    Scenario: User can get cluster by ID
        When User get cluster with id: "6"
        Then  Response is "200"
        And Response for list cluster by id is:"{u'status': u'Active', u'service_urls': {}, u'name': u'qacluster-1', u'base_image_id': u'd9342ba8-4c51-441c-8d5b-f9e14a901299', u'node_templates': {u'jt.medium': 1, u'nn.medium': 1}, u'nodes': []}"
    ...
    Scenario: User can delete cluster by ID
        When User delete cluster with id: "6"
        Then  Response is "204"
    ...
    Scenario: User can delete cluster by ID
        When User delete cluster with id: "8"
        Then  Response is "204"
    ...
    Scenario: User can delete cluster by ID
        When User delete cluster with id: "7"
        Then  Response is "204"
...
Scenario: User can get clusters if list is empty
    ...
    Scenario: User can get cluster by ID
        When User get cluster with id: "9"
        Then  Response is "200"
        And Response for list cluster by id is:"{u'status': u'Active', u'service_urls': {}, u'name': u'qacluster-1', u'base_image_id': u'd9342ba8-4c51-441c-8d5b-f9e14a901299', u'node_templates': {u'jt_nn.medium': 1}, u'nodes': []}"
    ...
    Scenario: User can delete cluster by ID
        When User delete cluster with id: "9"
        Then  Response is "204"
    ...
    Scenario: User can delete cluster by ID
        When User delete cluster with id: "11"
        Then  Response is "204"
    ...
    Scenario: User can delete cluster by ID
        When User delete cluster with id: "10"
        Then  Response is "204"
